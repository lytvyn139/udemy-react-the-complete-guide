...
- props are set/passed from outside App.js to Person.js component
- state is managed from inside of component
...
class NewPost extends Component { // state can only be accessed in 
